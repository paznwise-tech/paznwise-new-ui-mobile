...
export default function MyRentalsScreen() {
  ...
  const fetchRentals = async () => {
    try {
      ...
      console.warn('[MyRentals] Error fetching rentals:', err.message);
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  return (
    <SafeAreaView edges={['top']} style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>My Rented Artworks</Text>
        <View style={{ width: 36 }} />
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              <Text style={styles.emptyTitle}>No Rented Artworks</Text>
              <Text style={styles.emptySub}>Rent fine art for your office, living space, or events without buying outright.</Text>
              <TouchableOpacity
                style={styles.browseBtn}
                onPress={() => router.replace('/(tabs)/browse')}
              >
                <Text style={styles.browseBtnText}>Browse Art to Rent</Text>
              </TouchableOpacity>
            </View>
          }
        />
