    ...
    return (
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.productTitle}>{item.product?.title || item.title || 'Artwork Review'}</Text>
          <Text style={styles.dateText}>{dateStr}</Text>
        </View>

        {renderStars(item.rating || 5)}

        <Text style={styles.reviewComment}>{item.comment || item.review || 'Great quality artwork and packaging.'}</Text>
      </View>
    );
  };
