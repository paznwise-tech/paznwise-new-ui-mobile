...
import { View, Text, StyleSheet, ScrollView, FlatList, Dimensions, TouchableOpacity, TextInput } from 'react-native';
...
import { ARTWORKS, PERFORMERS, EVENTS, HERO_SLIDES, CATEGORIES } from '@/constants/data';
    ...
    <View style={{ flex: 1, backgroundColor: Colors.bg }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <FlatList
          ...
          keyExtractor={i => String(i.id)}
          renderItem={({ item }) => (
            <EventCard item={item} onPress={() => router.push('/(tabs)/events')} horizontal />
          )}
        />
